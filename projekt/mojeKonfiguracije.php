<?php
	...
	$result = mysql_query("SELECT * FROM konfiguracije where korisnik_idkorisnik='$loggedID'"); 
	...
	$smarty->assign("title", "Moje konfiguracije");
	$smarty->display("mojeKonfiguracije.tpl");
?>